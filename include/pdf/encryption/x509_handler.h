#ifndef UNLOCK_PDF_X509_HANDLER_H
#define UNLOCK_PDF_X509_HANDLER_H

#include "pdf/encryption/encryption_handler.h"

namespace unlock_pdf::pdf {

class X509SignatureHandler : public EncryptionHandler {
public:
    std::string name() const override { return "X.509 Digital Signatures"; }
...
#endif  // UNLOCK_PDF_X509_HANDLER_H
