...
public:
    ...
    // ==================== ADD OVERLOAD FOR C-STRINGS ====================
    /** Load a PdfMemDocument from a file (C-string overload for compatibility)
     *
     *  \param filename filename of the file which is going to be parsed/opened
     *  \param password password to open the PDF file
     */
    void Load(const char* filename, const char* password = nullptr);
    // ==================== END OF ADDITION ====================
